...
our $SCHEMA = [
    ...
    {item => ['google-chrome-stable', 'G-Chrome',        'google-chrome']},
    {item => ['telegram-desktop',     'Telegram',        'telegram']},
    {beg => ['Music',  'applications-multimedia']},
      {item => ['kitty -e ncmpcpp', 'Ncmpcpp', 'applications-multimedia']},
      {pipe => ['~/.config/openbox/pipe/pipempd.sh', 'Now Playing']},
    {end => undef},
    ...
    {item => ['flameshot gui', 'Screenshot', 'flameshot']},
    {item => ['openbox --reconfigure',               'Reconfigure Openbox', 'openbox']},
    {item => ['betterlockscreen -l dimblur', 'Lock', 'system-lock-screen']},
