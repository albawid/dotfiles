...
let s:p.normal.right = [[["#1B2B34", 15], ["#A7ADBA", 243], 'bold' ], [["#1B2B34", 15], ["#A7ADBA", 243], 'bold' ], [["#1B2B34", 15], ["#65737E", 243], 'bold' ]]
...
let s:p.insert.right = [[["#1B2B34", 15], ["#A7ADBA", 243], 'bold' ], [["#1B2B34", 15], ["#A7ADBA", 114], 'bold' ], [["#1B2B34", 15], ["#65737E", 243], 'bold' ]]

let s:p.replace.left = [[["#1B2B34", 15], ["#F9C762", 203], 'bold' ], [["#1B2B34", 15], ["#A7ADBA", 243], 'bold' ]]
let s:p.replace.middle = [[["#A7ADBA", 15], ["#343d46", 237]]]
let s:p.replace.right = [[["#1B2B34", 15], ["#A7ADBA", 243], 'bold' ], [["#1B2B34", 15], ["#A7ADBA", 203], 'bold' ], [["#1B2B34", 15], ["#65737E", 243], 'bold' ]]

let s:p.visual.left = [[["#1B2B34", 15], ["#C594C5", 209], 'bold' ], [["#1B2B34", 15], ["#A7ADBA", 243], 'bold' ]]
let s:p.visual.middle = [[["#A7ADBA", 15], ["#343d46", 237]]]
let s:p.visual.right = [[["#1B2B34", 15], ["#A7ADBA", 243], 'bold' ], [["#1B2B34", 15], ["#A7ADBA", 209], 'bold' ], [["#1B2B34", 15], ["#65737E", 243], 'bold' ]]
