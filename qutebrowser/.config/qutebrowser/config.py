...
# Type: Font
c.fonts.default_family = 'Iosevka, "xos4 Terminus", Terminus, "DejaVu Sans Mono", Monaco, "Bitstream Vera Sans Mono", "Andale Mono", "Courier New", Courier, "Liberation Mono", monospace, Fixed, Consolas, Terminal'
