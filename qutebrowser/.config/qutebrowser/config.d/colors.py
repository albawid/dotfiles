...
# Type: QtColor
c.colors.downloads.start.fg = xrdb["*color0"]
...
# Type: QtColor
c.colors.downloads.stop.fg = xrdb["*color0"]
...
# Type: QtColor
c.colors.tabs.selected.odd.bg = xrdb["*color8"]
...
# Type: QtColor
c.colors.tabs.selected.even.bg = xrdb["*color8"]
